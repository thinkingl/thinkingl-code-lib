...
double	CMD2Model::anorms_dots[ SHADEDOT_QUANT ][256] = {
#include	"anormtab.h"
};


static double	*shadedots = CMD2Model::anorms_dots[0];
...
//	m_texid = LoadTexture( filename );
    //if(m_texid != LoadTexture( "default" ))
    //    MessageBox(NULL, "Failed to bind the texture!", "" , MB_OK);
//	return (m_texid != LoadTexture( "default" ));
	m_texid = TextureManager::GetInstance()->GetTetureName( 11 );
	return 0;
}
